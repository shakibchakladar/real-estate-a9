...
const Contact = () => {
    return (
        <section className="py-6 pt-20 dark:bg-gray-100 dark:text-gray-900">
            <div className="my-5 h-[300px] hero" style={{backgroundImage: 'url(https://daisyui.com/images/stock/photo-1507358522600-9f71e620c44e.jpg)'}}>
